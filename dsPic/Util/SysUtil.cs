...
namespace dsPic.Util
{
    ...
    {
        private static SysUtil mInstance = null;
        ...
        public static string FormatSMS(String sender, List<String> receivers, int port, string function_id, string expiration_option, string body)
        {
            string receivers_text = "";
            foreach (string receiver in receivers)
            {
                if (receivers_text != "")
                {
                    receivers_text += ("_" + receiver);
                }
                else
                {
                    receivers_text += receiver;
                }
            }
            return string.Format("{0};{1};{2};{3};{4};{5}",
                ...
                receivers_text,
                port,
                function_id, //function id 1 means activate customer
                expiration_option, //message never expire
                body);
        }

        public static SysUtil Instance
        {
            get
            {
                if (mInstance == null)
        ...
        {
            return String.Format("{0}\\{1}", mApplicationPath, relative_path);
        }
